...
- 각각의 App에서 사용할 static 파일 저장 경로 설정
    ...
    - app을 위한 image, css, javascript 파일 저장
        ...
        <img src="./images/image_static1.PNG" width = "20%">
...
- static 경로에 저장된 파일들을 template에 지정하는 경우 
    - 하드코딩
        ...
        <img src="./images/image_static6.PNG" width = "50%">

    - template 태그 static를 이용

        <img src="./images/image_static7.PNG" width = "50%">
